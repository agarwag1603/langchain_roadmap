##MMR is Maximal Marginal Relevance (MMR) search - it balances between similarity and diversity. would reject redundant data.
...
docs = [
    Document(
        page_content="Glaciers are melting because of global warming.",
    ...
    Document(
        page_content="Antartica has not been habitable anymore due to ice turning to water.",
...
# {'type': 'Climate', 'id': 1, 'topic': 'Environment'} → Glaciers are melting because of global warming.
# {'id': 3, 'topic': 'Planet', 'type': 'Climate'} → Antartica has not been habitable anymore due to ice turning to water.
# {'id': 6, 'type': 'AI Concept', 'topic': 'RAG'} → Retrieval-Augmented Generation (RAG) combines external knowledge retrieval with generative models to improve factual accuracy.
# **************************************************
# Output with lambda_mult:0.5
# {'id': 1, 'type': 'Climate', 'topic': 'Environment'} → Glaciers are melting because of global warming.
# {'id': 6, 'type': 'AI Concept', 'topic': 'RAG'} → Retrieval-Augmented Generation (RAG) combines external knowledge retrieval with generative models to improve factual accuracy.
# {'id': 5, 'topic': 'Deep Learning', 'type': 'framework'} → TensorFlow and PyTorch are the two most popular deep learning frameworks used in research and production.
